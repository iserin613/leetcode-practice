...
- 难度: `Medium`
- 标签: 位运算(Bit Manipulation), 哈希表(Hash Table), 字符串(String), 回溯(Backtracking)
- 力扣(中文): https://leetcode.cn/problems/pyramid-transition-matrix/
- LeetCode(英文): https://leetcode.com/problems/pyramid-transition-matrix/
