...
- 难度: `Medium`
- 标签: 数组(Array), 哈希表(Hash Table), 二分查找(Binary Search)
- 力扣(中文): https://leetcode.cn/problems/closest-equal-element-queries/
- LeetCode(英文): https://leetcode.com/problems/closest-equal-element-queries/
