...
- 力扣(中文): https://leetcode.cn/problems/minimum-distance-between-three-equal-elements-ii/
- LeetCode(英文): https://leetcode.com/problems/minimum-distance-between-three-equal-elements-ii/
