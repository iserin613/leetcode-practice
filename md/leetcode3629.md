...
- 难度: `Medium`
- 标签: 广度优先搜索(Breadth-First Search), 数组(Array), 哈希表(Hash Table), 数学(Math), 数论(Number Theory)
- 力扣(中文): https://leetcode.cn/problems/minimum-jumps-to-reach-end-via-prime-teleportation/
- LeetCode(英文): https://leetcode.com/problems/minimum-jumps-to-reach-end-via-prime-teleportation/
